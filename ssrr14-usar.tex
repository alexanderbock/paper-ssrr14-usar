...
\begin{figure*}
	...
	\subfigure[Voxelized 3D point cloud rendering of a damaged office building.]{
		\fbox{\includegraphics[height=0.245\linewidth]{figures/image1.jpg}}\label{fig:teaser:1}
	}
	\hfill
	\subfigure[Viable paths through offices with two hazardous environments highlighted.]{
		\fbox{\includegraphics[height=0.245\linewidth]{figures/image2.jpg}}\label{fig:teaser:2}
	}
	\hfill
	\subfigure[Attributes derived in the data preprocessing stage. From left: distance to the closest hazard, occupancy, and level of support]{
	    \fbox{\includegraphics[height=0.245\linewidth, width=0.4\linewidth]{figures/fig-overview-fields-small.jpg}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.85\columnwidth]{figures/fig-overview-system2.jpg}}
...
\begin{figure}
	...
	\subfigure[Profile Plot]{
	    \fbox{\includegraphics[width=0.44\columnwidth]{figures/fig-analysis-profile.png}}
	    \label{fig:overview:analysis:profile}
	}
	\hfill
	\subfigure[Parallel Coordinates Plot]{
	    \fbox{\includegraphics[width=0.44\columnwidth]{figures/fig-analysis-pcp.png}}
...
\centering
   \subfigure[A construction site with an ensemble of paths starting from a construction worker standing on the edge of the pit.] {
       \fbox{\includegraphics[width=0.26\textwidth]{figures/tower-case-path.png}}
    ...
    \subfigure[An ensemble of paths calculated in the Bremen rescue arena, which is used to test the autonomy of search \& rescue robots.] {
        \fbox{\includegraphics[width=0.26\textwidth]{figures/rescue-case-path.png}}
        \label{fig:overview:case:arena}
   }
   \hfill{}
    \subfigure[An intermediate result of the path computation in the Tokohu case showing three classes of paths through the structure.]{
        \fbox{\includegraphics[width=0.26\textwidth]{figures/fig-analysis-rendering.jpg}}
